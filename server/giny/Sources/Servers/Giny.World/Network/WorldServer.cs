...
namespace Giny.World.Network
{
    public class WorldServer : Singleton<WorldServer>
    {
        ...
        private void OnServerStarted()
        {
            ...
            Giny.World.Managers.Web.OneAirUnhandledLogger.Start(); Giny.World.Managers.Web.OneAirActivityFeed.EnsureSchema(); Giny.World.Managers.Events.OneAirEventManager.Initialize(); Giny.World.Managers.HavenBag.OneAirHavenBagPatch.EnsureSchema(); Giny.World.Managers.HavenBag.OneAirHavenBagPatch.LoadInteractiveBindings(); Giny.World.Managers.HavenBag.OneAirHavenBagPatch.EnsureNoVanillaInhabitants(); Giny.World.Managers.Dungeons.OneAirDungeonResume.EnsureSchema(); Giny.World.Managers.Dungeons.OneAirDungeons.EnsureNpcs(); Giny.World.Managers.Dungeons.OneAirDungeons.EnsureDungeonGardiens(); Giny.World.Managers.Dungeons.OneAirDungeonResume.EnsureEntranceNpcs(); Giny.World.Managers.Dungeons.OneAirDungeonResume.FixVanillaReplies(); Giny.World.Managers.Dungeons.OneAirDungeonResume.EnsureEntranceDialogs(); Giny.World.Managers.Dungeons.OneAirDungeons.CleanupHubDialogs(); Giny.World.Managers.Web.OneAirActionPoller.Start(); Giny.World.Managers.Regen.OneAirRegenManager.Start(); SetServerStatus(ServerStatusEnum.ONLINE);
        }
    }
}
