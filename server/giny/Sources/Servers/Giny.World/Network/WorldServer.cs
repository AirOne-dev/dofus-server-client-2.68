...
namespace Giny.World.Network
{
    public class WorldServer : Singleton<WorldServer>
    {
        ...
        private void OnServerStarted()
        {
            ...
            Giny.World.Managers.Chat.OneAirUnhandledLogger.Start(); Giny.World.Managers.Chat.OneAirActivityFeed.EnsureSchema(); Giny.World.Managers.Chat.OneAirEventManager.Initialize(); Giny.World.Managers.Chat.OneAirHavenBagPatch.EnsureSchema(); Giny.World.Managers.Chat.OneAirHavenBagPatch.LoadInteractiveBindings(); Giny.World.Managers.Chat.OneAirDungeonResume.EnsureSchema(); Giny.World.Managers.Chat.OneAirDungeons.EnsureNpcs(); Giny.World.Managers.Chat.OneAirDungeons.EnsureDungeonGardiens(); Giny.World.Managers.Chat.OneAirDungeonResume.EnsureEntranceNpcs(); Giny.World.Managers.Chat.OneAirDungeonResume.FixVanillaReplies(); Giny.World.Managers.Chat.OneAirDungeonResume.EnsureEntranceDialogs(); Giny.World.Managers.Chat.OneAirDungeons.CleanupHubDialogs(); Giny.World.Managers.Chat.OneAirActionPoller.Start(); Giny.World.Managers.Chat.OneAirRegenManager.Start(); SetServerStatus(ServerStatusEnum.ONLINE);
        }
    }
}
