...
4. Lance le binaire avec ton dossier `client/build/OneAir.app/Contents/Resources` monté
...
- Le dossier `client/build/OneAir.app/Contents/Resources/data/` doit contenir :
...
|---|---|---|
| `DATA_DIR` | `./client/build/OneAir.app/Contents/Resources` | dossier client (doit contenir `data/`) |
